...
const ProductGallery = memo(({ product }) => {
  ...
  return /* @__PURE__ */ jsx(
    Swiper,
    {
      ...
      children: product?.gallery_images?.map((data, index) => /* @__PURE__ */ jsx(SwiperSlide, {
        children: /* @__PURE__ */ jsx("div", {
          className: "relative aspect-square h-full w-full", children: /* @__PURE__ */ jsx(
            "img",
            {
...
const PriceDisplay = memo(({ product, currentPrice }) => {
  ...
  if (discount > 0) {
    return /* @__PURE__ */ jsxs("div", {
      className: "flex flex-col items-start justify-start gap-1", children: [
      /* @__PURE__ */ jsx("div", {
        className: "mb-2 text-lg text-gray-500", children: /* @__PURE__ */ jsxs("bdi", {
          children: [
        /* @__PURE__ */ jsx("span", { children: "السعر قبل الخصم" }),
            " ",
        /* @__PURE__ */ jsx("span", { children: " : " }),
        /* @__PURE__ */ jsxs("span", {
              className: "line-through", children: [
                product.price,
                " ",
                currency
              ]
      ...
      /* @__PURE__ */ jsxs("bdi", {
        className: "mb-2 text-xl font-bold text-gray-900", children: [
      ...
      /* @__PURE__ */ jsxs("bdi", {
        className: "flex items-center text-lg font-semibold text-green-600", children: [
        /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("span", {
          className: "ml-2 rounded bg-green-100 px-2 py-1 text-sm font-medium text-green-600", children: [
            discount,
            "% خصم"
          ]
        })
  ...
  return /* @__PURE__ */ jsx("div", {
    className: "flex flex-col items-start justify-start gap-1", children: /* @__PURE__ */ jsxs("bdi", {
      className: "mb-2 text-lg font-normal text-[var(--second-color)]", children: [
...
const VariationsSelector = memo(({
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: variations.map((variation) => /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx("div", {
        className: "flex flex-col gap-3", children: variation.choices.map((choice) => /* @__PURE__ */ jsx("div", {
          className: "flex items-center", children: variation.is_required ? (
      ...
      /* @__PURE__ */ jsxs(
            ...
            /* @__PURE__ */ jsx("span", { className: "flex-1", children: choice.name }),
                choice.price > 0 && /* @__PURE__ */ jsxs("span", {
                  className: "text-sm font-medium text-gray-600", children: [
                    "+",
                    choice.price,
                    " ",
                    currency
...
const ProductOptions = memo(({
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      sizes && sizes.length > 0 && /* @__PURE__ */ jsxs("div", {
        className: "mt-6", children: [
      /* @__PURE__ */ jsx("h3", { className: "mb-2 text-lg font-semibold", children: "الحجم" }),
      /* @__PURE__ */ jsx("div", {
          className: "flex gap-2", children: sizes.map((sizeOption) => /* @__PURE__ */ jsx(
            "button",
            {
      ...
      colors && colors.length > 0 && /* @__PURE__ */ jsxs("div", {
        className: "mt-6", children: [
      /* @__PURE__ */ jsx("h3", { className: "mb-2 text-lg font-semibold", children: "اللون" }),
      /* @__PURE__ */ jsx("div", {
          className: "flex gap-2", children: colors.map((colorOption) => /* @__PURE__ */ jsx(
            "button",
            {
...
const CartActions = memo(({
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "mt-4 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs("div", {
      className: "mt-6 w-full", children: [
      /* @__PURE__ */ jsx(
        "label",
        {
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "flex items-center justify-between gap-3 max-md:fixed max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:z-50 max-md:flex-col-reverse max-md:bg-white max-md:px-8 max-md:py-6 max-md:pb-10 max-md:shadow-[0_0_10px_0_rgba(0,0,0,0.2)]", children: [
      /* @__PURE__ */ jsxs(
        Button,
        {
          loading,
      ...
      /* @__PURE__ */ jsxs("div", {
        className: "flex w-40 items-center justify-between gap-1 rounded-lg border bg-white p-4 max-md:w-full", children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            icon: "pi pi-plus",
...
const ProductSpecifications = memo(({
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: cn("my-6", className), children: [
    /* @__PURE__ */ jsx("h3", { className: "mb-4 text-xl font-semibold", children: "المواصفات" }),
    /* @__PURE__ */ jsxs("div", {
      className: "overflow-hidden rounded-lg border border-gray-200", children: [
      /* @__PURE__ */ jsx("table", {
        className: "w-full", children: /* @__PURE__ */ jsx("tbody", {
          children: visibleSpecifications.map((spec, index) => /* @__PURE__ */ jsxs(
            "tr",
            {
        ...
        hasMoreSpecifications && /* @__PURE__ */ jsx("div", {
          className: "flex justify-center border-t border-gray-200 p-3", children: /* @__PURE__ */ jsx(
            "button",
            {
...
function DetailPage({ product }) {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "container flex min-h-screen flex-col items-center justify-center py-10", children: [
    /* @__PURE__ */ jsxs("div", {
      className: "grid grid-cols-1 gap-8 bg-gray-100 p-8 lg:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("h5", {
          className: "my-2 w-fit rounded-lg bg-white px-6 py-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-4", children: parsedDescription }),
          ...
          product?.description_steps && product.description_steps.length > 0 && /* @__PURE__ */ jsxs("div", {
            className: "mt-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "mb-3 text-lg font-semibold", children: "المواصفات الأساسية" }),
          /* @__PURE__ */ jsx("ul", {
              className: "space-y-2", children: product.description_steps.map((step, index) => /* @__PURE__ */ jsxs("li", {
    ...
    /* @__PURE__ */ jsx("div", {
      className: "flex w-full items-center justify-between", children: product.technicalInformation && product.technicalInformation.length > 0 && /* @__PURE__ */ jsx(
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": pageTitle, "description": pageDescription, "keywords": pageKeywords, "image": productImage, "imageWidth": 1200, "imageHeight": 630 }, {
    "default": async ($$result2) => renderTemplate(_a || (_a = __template([" ", '  <script type="application/ld+json">', "<\/script> "])), renderComponent($$result2, "SettingsProvider", null, { "initialSettings": settingsData, "isLogin": isLogin, "cartCount": cartCount, "token": token, "client:only": "react", "client:component-hydration": "only", "client:component-path": "@/providers", "client:component-export": "SettingsProvider" }, {
