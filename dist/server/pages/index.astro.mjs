...
function Product({ product, defaultImage }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-[350px] flex-col", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsx(Link, { href: `/products/${product?.id}`, className: "block", children: /* @__PURE__ */ jsx("div", { className: "relative w-full aspect-square overflow-hidden bg-gray-50", children: imageSrc ? /* @__PURE__ */ jsx(
        Image,
        {
          src: imageSrc,
          alt: product?.name || "",
...
const SubCategories = ({ categories }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full sm:w-fit sm:max-w-[440px]", children: /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-gray-200 bg-white/80 px-2 py-1 shadow-sm max-md:w-full", children: /* @__PURE__ */ jsx(
    Swiper,
    {
      slidesPerView: "auto",
      spaceBetween: 8,
...
function Categories({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "container flex items-center justify-between py-8 max-md:flex-col max-md:items-start max-md:gap-4", children: [
      ...
      targetFilterCategory?.isSubCategory && /* @__PURE__ */ jsxs("div", { className: "flex max-w-full items-center gap-3 max-md:w-full max-md:flex-col max-md:items-start", children: [
