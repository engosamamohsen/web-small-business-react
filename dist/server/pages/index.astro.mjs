...
function ProductsSection({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxs("div", { className: "container relative mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-6 flex items-center justify-between sm:mb-8", children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-slate-900 sm:text-2xl", children: "أهم المنتجات" }) }),
