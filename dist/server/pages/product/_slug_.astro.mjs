...
import { b as useSettings, c as useSettingsData, F as FaviconHandler, H as Header, a as Footer, p as packageJson } from '../../chunks/package_DEA60gZM.mjs';
import { Swiper, SwiperSlide } from 'swiper/react';
import { Navigation } from 'swiper/modules';
/* empty css                                    */
import { s as styles } from '../../chunks/_slug_.c3207f35_BNLXg2IS.mjs';
import { u as useCartHook } from '../../chunks/cart_C9Mo9Ik1.mjs';
import Cookies from 'js-cookie';
import { c as cn, p as parseProductParam, b as buildProductPath } from '../../chunks/product-url_CFiTjzDR.mjs';
...
const AuthDialog = lazy(() => import('../../chunks/package_DEA60gZM.mjs').then(n => n.Q));
...
const CartPanel = lazy(() => import('../../chunks/CartPanel_DvJ0do-T.mjs'));
function DetailPage({
  product,
  settings: settingsProp
}) {
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$slug;
  const { slug: rawParam } = Astro2.params;
  ...
  const canonicalPath = buildProductPath({ ...productData, id });
  ...
  if (currentPath !== canonicalPath) {
    return Astro2.redirect(canonicalPath, 301);
  }
  const canonicalUrl = `${Astro2.url.origin}${canonicalPath}`;
...
}, "F:/react js projects/kamal/web-small-business-react/src/pages/product/[slug].astro", void 0);

const $$file = "F:/react js projects/kamal/web-small-business-react/src/pages/product/[slug].astro";
