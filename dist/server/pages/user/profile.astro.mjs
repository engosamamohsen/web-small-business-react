...
import { b as useAsync, $ as $api, a as useRouter, e as useMergeProps, P as PrimeReactContext, o as useHandleStyle, O as ObjectUtils, k as classNames, C as ComponentBase, B as Button, I as Image, H as Header, F as Footer, p as packageJson } from '../../chunks/package_DgEzYN_O.mjs';
...
function Profile() {
  ...
  if (!data) {
    return /* @__PURE__ */ jsxs("div", {
      className: "p-4 text-center", children: [
  ...
  const header = /* @__PURE__ */ jsxs("div", {
    className: "flex items-center justify-between pb-2", children: [
  ...
  return /* @__PURE__ */ jsx("div", {
    className: "p-4 md:p-6", children: /* @__PURE__ */ jsx(Card, {
      className: "mx-auto max-w-3xl shadow-md", header, dir: "rtl", children: /* @__PURE__ */ jsxs("div", {
        className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsx("div", {
          className: "flex justify-center", children: data.image_url ? /* @__PURE__ */ jsx("div", {
            className: "relative mx-auto h-[200px] w-[200px] overflow-hidden rounded-full", children: /* @__PURE__ */ jsx(
              Image,
              {
                src: data.image_url,
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
            className: "rounded-lg bg-gray-50 p-4 shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", {
              className: "mb-4 flex items-center gap-2", children: [
