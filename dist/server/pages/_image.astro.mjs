...
import { A as AstroError, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, c as ExpectedImageOptions, E as ExpectedImage, d as ExpectedNotESMImage, e as InvalidImageService, f as createAstro, g as createComponent, h as ImageMissingAlt, m as maybeRenderHead, i as addAttribute, s as spreadAttributes, r as renderTemplate } from '../chunks/astro/server_RokZUlch.mjs';
import { r as resolveSrc, i as isRemoteImage, a as isCoreRemotePath, b as isESMImportedImage, c as isLocalService, D as DEFAULT_HASH_PROPS, d as isRemoteAllowed } from '../chunks/astro/assets-service_DglvhAKO.mjs';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_DglvhAKO.mjs'
    ).then(n => n.s).catch((e) => {
