...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_UM0GDRms.mjs';
import { manifest } from './manifest_BDSWpFOe.mjs';
...
const _page12 = () => import('./pages/shop/cart.astro.mjs');
const _page13 = () => import('./pages/shop/checkout.astro.mjs');
const _page14 = () => import('./pages/user/orders.astro.mjs');
const _page15 = () => import('./pages/user/profile.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/shop/cart.astro", _page12],
    ["src/pages/shop/checkout.astro", _page13],
    ["src/pages/user/orders.astro", _page14],
    ["src/pages/user/profile.astro", _page15],
