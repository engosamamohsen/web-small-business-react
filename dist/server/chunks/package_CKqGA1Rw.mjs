...
import { User, LogOut, Search, ClipboardList, ShoppingCart, Phone, Mail, MapPin, Facebook, Instagram } from 'lucide-react';
...
import { f as fetchSettings } from './fetchSettings_DFAIddcx.mjs';
...
function _defineProperties(e, r) {
  for (var t = 0; t < r.length; t++) {
    var o = r[t];
    o.enumerable = o.enumerable || false, o.configurable = true, "value" in o && (o.writable = true), Object.defineProperty(e, toPropertyKey$9(o.key), o);
  }
}
...
var DomHandler = /*#__PURE__*/function () {
  ...
  return _createClass$1(DomHandler, null, [{
    ...
    value: function isDocument(obj) {
      return (typeof Document === "undefined" ? "undefined" : _typeof$9(Document)) === 'object' ? obj instanceof Document : obj && _typeof$9(obj) === 'object' && obj !== null && obj.nodeType === 9;
    }
  }, {
    key: "scrollInView",
...
var ObjectUtils = /*#__PURE__*/function () {
  ...
  return _createClass$1(ObjectUtils, null, [{
    ...
    value: function absoluteCompare(objA, objB) {
      ...
      if (_typeof$9(objA) !== _typeof$9(objB)) return false;
    ...
    value: function selectiveCompare(a, b, keysToCompare) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var isObject = _typeof$9(aValue) === 'object' && aValue !== null && _typeof$9(bValue) === 'object' && bValue !== null;
...
var Tooltip = /*#__PURE__*/React.memo(/*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var createElement = function createElement() {
    ...
    return /*#__PURE__*/React.createElement("div", _extends$5({
      ref: elementRef
    }, rootProps), /*#__PURE__*/React.createElement("div", arrowProps), /*#__PURE__*/React.createElement("div", _extends$5({
      ref: textRef
...
var classes$1$1 = {
  root: function root(_ref) {
    var props = _ref.props;
    return classNames('p-badge p-component', _defineProperty$2({
...
var classes$4 = {
  icon: function icon(_ref) {
    var props = _ref.props;
    return classNames('p-button-icon p-c', _defineProperty$2({}, "p-button-icon-".concat(props.iconPos), props.label));
  },
  ...
  root: function root(_ref3) {
    ...
    return classNames('p-button p-component', _defineProperty$2(_defineProperty$2(_defineProperty$2(_defineProperty$2({
...
var Button = /*#__PURE__*/React.memo(/*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var metaData = _objectSpread$4(_objectSpread$4({
    props: props
  }, props.__parentMetadata), {}, {
    context: {
      disabled: disabled
  ...
  var createIcon = function createIcon() {
    var className = classNames('p-button-icon p-c', _defineProperty$2({}, "p-button-icon-".concat(props.iconPos), props.label));
    ...
    var icon = props.loading ? props.loadingIcon || /*#__PURE__*/React.createElement(SpinnerIcon, _extends$4({}, loadingIconProps, {
      spin: true
    })) : props.icon;
    return IconUtils.getJSXIcon(icon, _objectSpread$4({}, iconsProps), {
      props: props
    });
  };
  var createLabel = function createLabel() {
    ...
    return !props.children && !props.label && /*#__PURE__*/React.createElement("span", _extends$4({}, labelProps, {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", rootProps, icon, label, props.children, badge, /*#__PURE__*/React.createElement(Ripple, null)), hasTooltip && /*#__PURE__*/React.createElement(Tooltip, _extends$4({
    target: elementRef,
...
var InputText = /*#__PURE__*/React.memo(/*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("input", _extends$3({
    ref: elementRef
  }, rootProps)), hasTooltip && /*#__PURE__*/React.createElement(Tooltip, _extends$3({
    target: elementRef,
    content: props.tooltip,
    pt: ptm('tooltip')
  }, props.tooltipOptions)));
...
const useAuthHook = () => {
  ...
  const login = async (inputs, onSuccess, onNeedVerify) => {
    try {
      setLoading(true);
      const { data: response } = await $api.post(
        `v1/login-user`,
  ...
  const register = async (inputs, onSuccess, onNeedVerify) => {
    try {
      setLoading(true);
      const { data: response } = await $api.post(
        `v1/register-user`,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-stretch justify-center gap-4", children: [
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              icon: !googleLoading ? /* @__PURE__ */ jsx(
                Image,
                {
              ...
              children: googleLoading ? "جارٍ تسجيل الدخول..." : "Sign In with Google"
            }
          ),
  ...
  const sendOtp = async (data) => {
    ...
    try {
      ...
      toast.error(
        ...
        { position: "top-right", autoClose: 2e3, rtl: true }
      );
      return false;
    } finally {
      setLoading(false);
    ...
    try {
      const { data: response } = await $api.post(
        ...
        },
        {
          ...
          headers: resetToken ? { Authorization: `Token ${resetToken}` } : void 0
        }
      );
      if (response?.status === true || response?.status === 200) {
...
const useVerifyEmail = () => {
  const [loading, setLoading] = useState(false);
  const router = useRouter();
  const verifyEmail = async (email, code, mode = "register", onVerified) => {
    try {
      setLoading(true);
      const formData = new FormData();
      formData.append("email", email);
...
function VerifyForm({
  ...
  const [mode, setMode] = useState(propMode || "register");
  ...
  const title = mode === "reset" ? "التحقق لاستعادة كلمة المرور" : "التحقق من البريد الإلكتروني";
  const subtitle = mode === "reset" ? "أدخل رمز التحقق المرسل إلى بريدك لإعادة تعيين كلمة المرور" : "أدخل رمز التحقق المرسل إلى بريدك الإلكتروني";
  return /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      dir: "rtl",
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex w-full flex-col items-center justify-center gap-2 text-center", children: /* @__PURE__ */ jsxs("div", { className: "mb-4 mt-4 flex w-full flex-col items-center justify-center gap-3 text-black", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-full bg-[var(--main-color)] text-white", children: /* @__PURE__ */ jsx("i", { className: "pi pi-envelope text-2xl" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-black", children: title }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: subtitle }),
          email && /* @__PURE__ */ jsx("p", { className: "rounded-md bg-gray-100 px-3 py-1 text-sm font-medium text-[var(--main-color)]", children: email })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "otp-code", className: "block text-sm font-medium text-black", children: "رمز التحقق" }),
          /* @__PURE__ */ jsx(
            InputText,
            {
              id: "otp-code",
        ...
        onSwitchToLogin && /* @__PURE__ */ jsx("div", { className: "text-center text-sm text-gray-500", children: /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            onClick: onSwitchToLogin,
...
function ResetPasswordForm({
  ...
  return /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex w-full flex-col items-center justify-center gap-2 text-center", children: /* @__PURE__ */ jsxs("div", { className: "mb-4 mt-4 flex w-full flex-col items-center justify-center gap-3 text-black", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-full bg-[var(--main-color)] text-white", children: /* @__PURE__ */ jsx("i", { className: "pi pi-lock text-2xl" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-black", children: "إعادة تعيين كلمة المرور" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "أدخل كلمة المرور الجديدة" })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "new_password", className: "block text-sm font-medium text-black", children: "كلمة المرور الجديدة" }),
          /* @__PURE__ */ jsx(
            Password,
            {
              id: "new_password",
          ...
          errors.new_password && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.new_password.message })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "new_password_confirmation", className: "block text-sm font-medium text-black", children: "تأكيد كلمة المرور الجديدة" }),
          /* @__PURE__ */ jsx(
            Password,
            {
          ...
          errors.new_password_confirmation && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.new_password_confirmation.message })
        ] }),
        /* @__PURE__ */ jsx(
          Button,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "text-center text-sm text-gray-500", children: onSwitchToLogin ? /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            onClick: onSwitchToLogin,
        ...
        ) : /* @__PURE__ */ jsx(Link, { href: "/auth/login", className: "font-medium text-[var(--second-color)] hover:underline", children: "العودة إلى تسجيل الدخول" }) })
      ]
    }
  );
}
...
function AuthDialog({
  ...
  const handleSuccess = () => {
    fetchSettings(void 0, true).then(() => {
  ...
  const handleNeedVerify = (email) => {
    setPendingEmail(email);
    setVerifyMode("register");
    setScreen("verify");
  };
  const handleRegisterNeedVerify = (email) => {
    setPendingEmail(email);
    setVerifyMode("register");
    setScreen("verify");
  };
  const handleForgotNeedVerify = (email) => {
    setPendingEmail(email);
    setVerifyMode("reset");
    setScreen("verify");
  };
  const handleVerified = (email, otp) => {
    if (verifyMode === "reset") {
      setPendingEmail(email);
      setPendingOtp(otp);
  ...
  return /* @__PURE__ */ jsxs(
    Dialog,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl overflow-hidden", children: screen === "verify" ? /* @__PURE__ */ jsx(
          VerifyForm,
          {
            email: pendingEmail,
            mode: verifyMode,
        ...
        ) : screen === "resetPassword" ? /* @__PURE__ */ jsx(
          ResetPasswordForm,
          {
            email: pendingEmail,
            otp: pendingOtp,
        ...
        ) : screen === "forgotPassword" ? /* @__PURE__ */ jsx(
          ForgotPasswordForm,
          {
            initSettings,
            onSwitchToLogin: () => setScreen("login"),
...
const AuthDialog$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: AuthDialog
}, Symbol.toStringTag, { value: 'Module' }));

function Header({ initialIsLoggedIn = false, settingsData }) {
  const { settings: contextSettings, isLogin: contextIsLogin, cartCount } = useSettings();
  const [isLoggedIn, setIsLoggedIn] = useState(initialIsLoggedIn);
  const [showAuthDialog, setShowAuthDialog] = useState(false);
  const [settings, setSettings] = useState(settingsData || contextSettings || null);
  const router = useRouter();
  useEffect(() => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 md:flex-row md:items-center md:justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              ...
              settings?.contact_email && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-400", children: [
                /* @__PURE__ */ jsx(Mail, { size: 12, className: "shrink-0" }),
                /* @__PURE__ */ jsx(
                  "a",
                  {
              ...
              settings?.full_address && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 text-xs text-gray-400", children: [
                /* @__PURE__ */ jsx(MapPin, { size: 12, className: "mt-0.5 shrink-0" }),
                /* @__PURE__ */ jsx("span", { children: settings.full_address })
              ] })
            ] })
          ] }),
