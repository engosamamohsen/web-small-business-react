...
import React__default, { useContext, useEffect, useState, useRef, useCallback, createContext, Children, cloneElement } from 'react';
import { __assign } from 'tslib';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { User, LogOut, Search, ClipboardList, ShoppingCart, Phone, Facebook, Instagram } from 'lucide-react';
import Cookies from 'js-cookie';
import { f as fetchPublicSettings } from './fetchSettings_Ldq5l7Md.mjs';
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex h-16 items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-white shadow-sm", children: settingsResponse?.data?.logo ? /* @__PURE__ */ jsx(CircleLogo, { src: settingsResponse?.data?.logo, size: 36 }) : /* @__PURE__ */ jsx("span", { className: "text-sm font-bold", children: settingsResponse?.data?.name?.charAt(0) || "S" }) }),
                  settingsResponse?.data?.name && /* @__PURE__ */ jsx("span", { className: "hidden text-lg font-semibold text-[var(--main-font-color)] sm:block", children: settingsResponse?.data?.name })
                ]
              }
            ),
